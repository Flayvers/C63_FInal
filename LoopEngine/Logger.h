...
#define ASSERT(test, msg) if(not (test)) {LOG(msg,LE::TLevel::eERROR);}
...
namespace LE
{
    ...
    public:
        ...
        Logger(const TLevel InLoggingLevel = TLevel::eWARNING, bool InConsoleTraceActive = true, bool InFileTraceActive = true, bool InScreenTraceActive = false);
        virtual ~Logger();
